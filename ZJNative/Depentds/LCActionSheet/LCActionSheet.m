    ...
    if (self = [super init]) {
        ...
        if (titles.count) {
            ...
            for (int i = 0; i < titles.count; i++) {
                ...
                NSString *linePath = [bundlePath stringByAppendingPathComponent:@"ZJNativeBundle.bundle/bgImage_HL@2x.png"];
            ...
            for (int i = 0; i < titles.count; i++) {
                ...
                NSString *linePath = [bundlePath stringByAppendingPathComponent:@"ZJNativeBundle.bundle/cellLine@2x.png"];
        ...
        [cancelBtn setBackgroundImage:[UIImage imageNamed:@"ZJNativeBundle.bundle/bgImage_HL"] forState:UIControlStateHighlighted];
