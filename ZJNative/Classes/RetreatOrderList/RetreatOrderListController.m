...
#import "RetreatOrderListUpController.h"
#import "Macro.h"
#import "UIColor+Extension.h"
@interface RetreatOrderListController ()<UIScrollViewDelegate>
@property(nonatomic,strong)UIView *greenView1;
@property(nonatomic,strong)UIView *greenView2;
@property(nonatomic,strong)UIScrollView *scrollView;
@property(nonatomic,strong)RetreatOrderListUnupController *mallVc;
@property(nonatomic,strong)RetreatOrderListUpController *jiudian;

@end

@implementation RetreatOrderListController
...
- (void)viewDidLoad {
    ...
    for (int i=0; i<2; i++) {
        ...
        [button setTitle:@"未上传退单" forState:UIControlStateNormal];
        
        if (i==1) {
            [button setTitle:@"已上传退单" forState:UIControlStateNormal];
        }
...
- (void)addController{
    _mallVc = [[RetreatOrderListUnupController alloc]init];
    _jiudian = [[RetreatOrderListUpController alloc]init];
