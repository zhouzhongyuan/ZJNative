...
//        UINib *cellNib=[UINib nibWithNibName:@"ManagementCollectionCell" bundle:nil];
        ...
        NSString * bundlePath = [[ NSBundle mainBundle] pathForResource: @"ZJNativeBundle" ofType :@"bundle"];
        NSBundle *resourceBundle = [NSBundle bundleWithPath:bundlePath];
        UINib *cellNib=[UINib nibWithNibName:@"ManagementCollectionCell" bundle:resourceBundle];
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"功能管理";
    _images = @[@"ZJNativeBundle.bundle/icon_placeOrder",@"ZJNativeBundle.bundle/icon_backOrder",@"ZJNativeBundle.bundle/icon_queryStock",@"ZJNativeBundle.bundle/icon_queryPrice",@"ZJNativeBundle.bundle/icon_queryActivity",@"ZJNativeBundle.bundle/icon_orderList",@"ZJNativeBundle.bundle/icon_backOrderList"];
