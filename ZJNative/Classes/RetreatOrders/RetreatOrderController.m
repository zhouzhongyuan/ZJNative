...
- (void)viewDidLoad {
    ...
    [self judgeTheChangeOfSupermarket];
    self.title = @"销售退货通知";
...
-(void)judgeTheChangeOfSupermarket{
    NSUserDefaults *defatults = [NSUserDefaults standardUserDefaults];
    if (![[defatults objectForKey:@"retreatCustomer"] isEqualToString:SIGLETON.customerModel.code]) {
        [defatults setValue:SIGLETON.customerModel.code forKey:@"retreatCustomer"];
...
-(void)saveAction{
    ...
    [defaults removeObjectForKey:@"image4"];
    [defaults removeObjectForKey:@"reasonCode"];
    [defaults removeObjectForKey:@"retreatCustomer"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 1) {
        if (indexPath.row == _dataSource.count) {
            ...
            cell.imageView.image = [UIImage imageNamed:@"ZJNativeBundle.bundle/icon_add"];
            return cell;
    ...
    if (indexPath.row == 5) {
        ...
        if (_headerImage4) {
            ...
            [cell.button2 setImage:_headerImage2 forState:UIControlStateNormal];
            [cell.button3 setImage:_headerImage3 forState:UIControlStateNormal];
            [cell.button4 setImage:[UIImage imageNamed:@"ZJNativeBundle.bundle/camera"] forState:UIControlStateNormal];
        }else if(_headerImage2){
            [cell.botton1 setImage:_headerImage1 forState:UIControlStateNormal];
            [cell.button2 setImage:_headerImage2 forState:UIControlStateNormal];
            [cell.button3 setImage:[UIImage imageNamed:@"ZJNativeBundle.bundle/camera"] forState:UIControlStateNormal];
            [cell.button4 setHidden:YES];
        }else if (_headerImage1){
            [cell.botton1 setImage:_headerImage1 forState:UIControlStateNormal];
            [cell.button2 setImage:[UIImage imageNamed:@"ZJNativeBundle.bundle/camera"] forState:UIControlStateNormal];
            [cell.button3 setHidden:YES];
            [cell.button4 setHidden:YES];
        }else{
            [cell.botton1 setImage:[UIImage imageNamed:@"ZJNativeBundle.bundle/camera"] forState:UIControlStateNormal];
